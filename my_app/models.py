...
class newProject(models.Model):
    ...
    brochure = CloudinaryField('brochure', resource_type='raw',folder='brochures/', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Lease(models.Model):
    ...
    def __str__(self):
        return f"{self.property_type} in {self.location} by {self.agent_name}"
